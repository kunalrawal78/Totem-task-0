...
const roles = ["ChatGpt","Gemini","Claude","Grok"];

const DropdownAi = () => {
  const [selected, setSelected] = useState("Choose an AI you use");
  const [open, setOpen] = useState(false);

  return (
    <div className="relative  text-center text-[12px] w-58 dark:text-black  ">
